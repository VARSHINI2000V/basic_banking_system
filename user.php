    ...
    <div class="screen" >
        ...
        <div class="screen-body-item" style="border-color:black">
          <form class="app-form" method="post">
            ...
            <div class="app-form-group">
              <input class="app-form-control" placeholder="Enter Your Current Balance" type="number" name="balance" required>
            </div>
            <br>
            <div class="app-form-group button">
              <input class="app-form-button" type="submit" value="Create Account" name="submit"></input>
              <input class="app-form-button" type="reset" value="Reset Account" name="reset"></input>
            </div>
          </form>
        </div>
